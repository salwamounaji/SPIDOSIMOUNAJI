        ...
        return (h("nav", { class: "navbar is-transparent" },
            h("div", { class: "navbar-brand" },
                h("span", { class: "navbar-item" },
                    h("h1", null, "SPI-ADM"))),
            h("div", { id: "navbarExampleTransparentExample", class: "navbar-menu" },
                h("div", { class: "navbar-start" },
                    h("div", { class: "navbar-item has-dropdown is-hoverable" },
                        h("a", { class: "navbar-link", href: "/ListFormation/" },
                            h("span", null,
                                h("i", { class: "fas fa-tools" })),
                            " ",
                            "Formation"),
                        h("div", { class: "navbar-dropdown is-boxed" },
                            h("a", { class: "navbar-item", href: "/ListFormation/" }, "List des formations"),
                            h("a", { class: "navbar-item", href: "/AddFormation/" }, "Ajout d'une formation"),
                            h("a", { class: "navbar-item", href: "/SearchFormation/" }, "Chercher une formation"))),
                    h("div", { class: "navbar-item has-dropdown is-hoverable" },
                        h("a", { class: "navbar-link", href: "/ListEnseignant/" },
                            h("span", null,
                                h("i", { class: "fas fa-chalkboard-teacher" })),
                            " ",
                            "Enseignant"),
                        h("div", { class: "navbar-dropdown is-boxed" },
                            h("a", { class: "navbar-item", href: "/ListEnseignant/" }, "List des enseignants"),
                            h("a", { class: "navbar-item", href: "/AddEnseignant/" }, "Ajout d'un enseignant"),
                            h("a", { class: "navbar-item", href: "/SearchEnseignant/" }, "Chercher un enseignant")))))));
    }
    static get is() { return "spi-header"; }
            ...
            h("main", null,
                h("stencil-router", null,
                    h("stencil-route-switch", { scrollTopOffset: 0 },
                        h("stencil-route", { url: "/", component: "spi-home", exact: true }),
                        h("stencil-route", { url: '/AddEnseignant', component: 'app-add-enseignant' }),
                        h("stencil-route", { url: '/AddFormation', component: 'app-add-formation' }),
                        h("stencil-route", { url: '/EditFormation/:id', component: 'app-edit-formation' }),
                        h("stencil-route", { url: '/ListEnseignant', component: 'app-list-enseignant' }),
                        h("stencil-route", { url: '/ListFormation', component: 'app-list-formation' }),
                        h("stencil-route", { url: '/detailsEnseignant/:id', component: 'app-details-enseignant' }),
                        h("stencil-route", { url: '/detailsFormation/:id', component: 'app-details-formation' }),
                        h("stencil-route", { url: '/SearchEnseignant', component: 'app-search-enseignant' }),
                        h("stencil-route", { url: '/SearchFormation', component: 'app-search-formation' }))))));
    }
    static get is() { return "spi-root"; }
...
export { SpiHeader, SpiRoot, Route as StencilRoute, RouteSwitch as StencilRouteSwitch, Router as StencilRouter };
